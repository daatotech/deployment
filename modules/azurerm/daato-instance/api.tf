locals {
  api_env = {
    ...
    AUTH0_SCS_SUPPLIER_RELATIONSHIP_MANAGER_ROLE_ID   = var.auth0.roles.scs_supplier_relationship_manager.id
    AUTH0_SCS_MODULE_MANAGER_ROLE_ID                  = var.auth0.roles.scs_module_manager.id
    AUTH0_GEN_PROFILE_MANAGER_ROLE_ID                 = var.auth0.roles.gen_profile_manager.id
    AUTH0_SUBSIDIARY_UNIT_MANAGER_ROLE_ID             = var.auth0.roles.subsidiary_unit_manager.id
    AUTH0_SUBSIDIARY_APPROVER_ROLE_ID                 = var.auth0.roles.subsidiary_approver.id
    AUTH0_CONSULTING_CLIENT_REPORTING_MANAGER_ROLE_ID = var.auth0.roles.consulting_client_reporting_manager.id
    AUTH0_CONSULTING_CLIENT_MANAGER_ROLE_ID           = var.auth0.roles.consulting_client_manager.id
